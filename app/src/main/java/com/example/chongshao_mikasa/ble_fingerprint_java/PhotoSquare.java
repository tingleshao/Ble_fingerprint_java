...
/**
 * Created by chongshao-mikasa on 11/16/16.
 */
...
//here is the problem when ever i command bitmap it will be working .with out command its //showing null pointer exception
    ...
    public void draw(GL10 gl) {
        if (bitmap != null) {
            Log.d("T", "hi here!" + String.valueOf( bitmap.getWidth()) + " " + String.valueOf(bitmap.getHeight()) +
             String.valueOf(bitmap.getPixel(1,1)) + String.valueOf(bitmap.getPixel(200, 200)));
            GLUtils.texImage2D(GL10.GL_TEXTURE_2D, 0, bitmap, 0);
